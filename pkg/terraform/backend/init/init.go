...
import (
	...
	backendLocal "github.com/fugue/regula/pkg/terraform/backend/local"
	backendRemote "github.com/fugue/regula/pkg/terraform/backend/remote"
	backendArtifactory "github.com/fugue/regula/pkg/terraform/backend/remote-state/artifactory"
	backendAzure "github.com/fugue/regula/pkg/terraform/backend/remote-state/azure"
	backendConsul "github.com/fugue/regula/pkg/terraform/backend/remote-state/consul"
	backendCos "github.com/fugue/regula/pkg/terraform/backend/remote-state/cos"
	backendEtcdv2 "github.com/fugue/regula/pkg/terraform/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/fugue/regula/pkg/terraform/backend/remote-state/etcdv3"
	backendGCS "github.com/fugue/regula/pkg/terraform/backend/remote-state/gcs"
	backendHTTP "github.com/fugue/regula/pkg/terraform/backend/remote-state/http"
	backendInmem "github.com/fugue/regula/pkg/terraform/backend/remote-state/inmem"
	backendKubernetes "github.com/fugue/regula/pkg/terraform/backend/remote-state/kubernetes"
	backendManta "github.com/fugue/regula/pkg/terraform/backend/remote-state/manta"
	backendOSS "github.com/fugue/regula/pkg/terraform/backend/remote-state/oss"
	backendPg "github.com/fugue/regula/pkg/terraform/backend/remote-state/pg"
	backendS3 "github.com/fugue/regula/pkg/terraform/backend/remote-state/s3"
	backendSwift "github.com/fugue/regula/pkg/terraform/backend/remote-state/swift"
)
