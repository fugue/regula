...
import (
	...
	"github.com/fugue/regula/pkg/terraform/command/cliconfig"
	oauthserver "github.com/fugue/regula/pkg/terraform/command/testdata/login-oauth-server"
	tfeserver "github.com/fugue/regula/pkg/terraform/command/testdata/login-tfe-server"
