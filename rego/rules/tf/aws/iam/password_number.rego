...
package rules.tf_aws_iam_password_number
...
__rego__metadoc__ := {
  ...
  "description": "IAM password policies should require at least one number. IAM password policies are used to enforce password complexity requirements. Setting a password complexity policy that requires at least one number increases account resiliency against brute force login attempts.",
  "id": "FG_R00024",
  "title": "IAM password policies should require at least one number"
}
