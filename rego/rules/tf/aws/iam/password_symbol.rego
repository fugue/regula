...
package rules.tf_aws_iam_password_symbol
...
__rego__metadoc__ := {
  ...
  "description": "IAM password policies should require at least one symbol. IAM password policies are used to enforce password complexity requirements. Setting a password complexity policy that requires at least one symbol increases account resiliency against brute force login attempts.",
  "id": "FG_R00023",
  "title": "IAM password policies should require at least one symbol"
}
