...
package rules.tf_aws_security_groups_ingress_1434
...
__rego__metadoc__ := {
  ...
  "id": "FG_R00249",
  "title": "VPC security group rules should not permit ingress from '0.0.0.0/0' to TCP/UDP port 1434 (MSSQL Admin)"
}
...
deny {
  library.security_group_ingress_zero_cidr_to_port(input, 1434)
}
