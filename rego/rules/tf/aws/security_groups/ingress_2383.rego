...
package rules.tf_aws_security_groups_ingress_2383
...
__rego__metadoc__ := {
  ...
  "id": "FG_R00257",
  "title": "VPC security group rules should not permit ingress from '0.0.0.0/0' to TCP/UDP port 2383 (SQL Server Analysis Services)"
}
...
deny {
  library.security_group_ingress_zero_cidr_to_port(input, 2383)
}
