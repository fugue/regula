...
package rules.tf_aws_security_groups_ingress_9300
...
__rego__metadoc__ := {
  ...
  "id": "FG_R00213",
  "title": "VPC security group rules should not permit ingress from '0.0.0.0/0' to TCP/UDP port 9300 (Elasticsearch)"
}
...
policy[j] {
  ...
  library.security_group_ingress_zero_cidr_to_port(sg, 9300)
