...
package tests.rules.cfn.api_gateway.inputs.invalid_classic_custom_domain_name_sam_infra_yaml
...
mock_config := {
  ...
  "Description": "Invalid classic custom domain name configurations",
  "Resources": {
    "ServerlessAPI": {
      "Properties": {
        "Domain": {
