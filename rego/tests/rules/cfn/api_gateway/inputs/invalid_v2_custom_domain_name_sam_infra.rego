...
#
#     tests/rules/cfn/api_gateway/inputs/invalid_v2_custom_domain_name_sam_infra.cfn
#
...
package tests.rules.cfn.api_gateway.inputs.invalid_v2_custom_domain_name_sam_infra

import data.fugue.regula.tests

mock_config := regula_load_type("invalid_v2_custom_domain_name_sam_infra.cfn", "cfn")
