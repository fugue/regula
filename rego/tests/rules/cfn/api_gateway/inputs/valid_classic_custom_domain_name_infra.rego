...
#
#     tests/rules/cfn/api_gateway/inputs/valid_classic_custom_domain_name_infra.cfn
#
...
package tests.rules.cfn.api_gateway.inputs.valid_classic_custom_domain_name_infra

import data.regula

mock_config := regula_load_type("valid_classic_custom_domain_name_infra.cfn", "cfn")
