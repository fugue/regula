...
#
#     tests/rules/cfn/api_gateway/inputs/valid_v2_custom_domain_name_infra.cfn
#
...
package tests.rules.cfn.api_gateway.inputs.valid_v2_custom_domain_name_infra

import data.fugue.regula.tests

mock_config := regula_load_type("valid_v2_custom_domain_name_infra.cfn", "cfn")
