...
#
#     tests/rules/cfn/cloudtrail/inputs/invalid_encryption_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.invalid_encryption_infra

import data.fugue.regula.tests

mock_config := regula_load_type("invalid_encryption_infra.cfn", "cfn")
