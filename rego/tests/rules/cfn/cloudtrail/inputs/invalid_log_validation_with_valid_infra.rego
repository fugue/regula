...
#
#     tests/rules/cfn/cloudtrail/inputs/invalid_log_validation_with_valid_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.invalid_log_validation_with_valid_infra

import data.fugue.regula.tests

mock_config := regula_load_type("invalid_log_validation_with_valid_infra.cfn", "cfn")
