...
#
#     tests/rules/cfn/cloudtrail/inputs/invalid_s3_access_logging_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.invalid_s3_access_logging_infra

import data.regula

mock_config := regula_load_type("invalid_s3_access_logging_infra.cfn", "cfn")
