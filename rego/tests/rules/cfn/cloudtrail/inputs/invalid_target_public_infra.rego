...
#
#     tests/rules/cfn/cloudtrail/inputs/invalid_target_public_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.invalid_target_public_infra

import data.fugue.regula.tests

mock_config := regula_load_type("invalid_target_public_infra.cfn", "cfn")
