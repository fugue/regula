...
#
#     tests/rules/cfn/cloudtrail/inputs/invalid_target_public_write_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.invalid_target_public_write_infra

import data.regula

mock_config := regula_load_type("invalid_target_public_write_infra.cfn", "cfn")
