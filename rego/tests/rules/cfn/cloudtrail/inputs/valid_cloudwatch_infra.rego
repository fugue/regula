...
#
#     tests/rules/cfn/cloudtrail/inputs/valid_cloudwatch_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.valid_cloudwatch_infra

import data.fugue.regula.tests

mock_config := regula_load_type("valid_cloudwatch_infra.cfn", "cfn")
