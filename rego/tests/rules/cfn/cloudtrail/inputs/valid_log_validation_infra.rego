...
#
#     tests/rules/cfn/cloudtrail/inputs/valid_log_validation_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.valid_log_validation_infra

import data.regula

mock_config := regula_load_type("valid_log_validation_infra.cfn", "cfn")
