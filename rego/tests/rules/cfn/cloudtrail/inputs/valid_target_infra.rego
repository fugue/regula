...
#
#     tests/rules/cfn/cloudtrail/inputs/valid_target_infra.cfn
#
...
package tests.rules.cfn.cloudtrail.inputs.valid_target_infra

import data.regula

mock_config := regula_load_type("valid_target_infra.cfn", "cfn")
