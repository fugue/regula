...
#
#     tests/rules/cfn/kms/inputs/key_rotation_infra.cfn
#
...
package tests.rules.cfn.kms.inputs.key_rotation_infra

import data.fugue.regula.tests

mock_config := regula_load_type("key_rotation_infra.cfn", "cfn")
