...
#
#     tests/rules/cfn/lambda/inputs/empty_template_infra.cfn
#
...
package tests.rules.cfn.lambda.inputs.empty_template_infra

import data.fugue.regula.tests

mock_config := regula_load_type("empty_template_infra.cfn", "cfn")
