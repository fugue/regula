...
#
#     tests/rules/cfn/lambda/inputs/invalid_function_not_public_sam_infra.cfn
#
...
package tests.rules.cfn.lambda.inputs.invalid_function_not_public_sam_infra

import data.fugue.regula.tests

mock_config := regula_load_type("invalid_function_not_public_sam_infra.cfn", "cfn")
