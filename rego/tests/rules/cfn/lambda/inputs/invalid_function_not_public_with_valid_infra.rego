...
#
#     tests/rules/cfn/lambda/inputs/invalid_function_not_public_with_valid_infra.cfn
#
...
package tests.rules.cfn.lambda.inputs.invalid_function_not_public_with_valid_infra

import data.regula

mock_config := regula_load_type("invalid_function_not_public_with_valid_infra.cfn", "cfn")
