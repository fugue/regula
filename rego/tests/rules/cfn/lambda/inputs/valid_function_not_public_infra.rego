...
#
#     tests/rules/cfn/lambda/inputs/valid_function_not_public_infra.cfn
#
...
package tests.rules.cfn.lambda.inputs.valid_function_not_public_infra

import data.regula

mock_config := regula_load_type("valid_function_not_public_infra.cfn", "cfn")
