...
#
#     tests/rules/cfn/lambda/inputs/valid_function_not_public_service_permission_infra.cfn
#
...
package tests.rules.cfn.lambda.inputs.valid_function_not_public_service_permission_infra

import data.fugue.regula.tests

mock_config := regula_load_type("valid_function_not_public_service_permission_infra.cfn", "cfn")
