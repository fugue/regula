...
test_valid_cloudtrail_s3_data_logging_write_all_buckets {
  pol = policy with input as inputs.valid_cloudtrail_s3_data_logging_write_all_buckets_infra_yaml.mock_input
  by_resource_id = {p.id: p.valid | pol[p]}
...
test_invalid_cloudtrail_s3_data_logging_write_one_bucket {
  pol = policy with input as inputs.invalid_cloudtrail_s3_data_logging_write_one_bucket_infra_yaml.mock_input
  by_resource_id = {p.id: p.valid | pol[p]}
  count(by_resource_id) == 2
  by_resource_id["LoggingBucket"] == true
  by_resource_id["Bucket1"] == false
...
test_invalid_cloudtrail_s3_data_logging_write_one_bucket_read_all {
  pol = policy with input as inputs.invalid_cloudtrail_s3_data_logging_write_one_bucket_read_all_infra_yaml.mock_input
  by_resource_id = {p.id: p.valid | pol[p]}
  count(by_resource_id) == 4
  by_resource_id["LoggingBucket"] == true
  by_resource_id["Bucket1"] == false
