...
#
#     tests/rules/cfn/s3/inputs/invalid_cloudtrail_s3_data_logging_no_trails_infra.cfn
#
...
package tests.rules.cfn.s3.inputs.invalid_cloudtrail_s3_data_logging_no_trails_infra

import data.regula

mock_config := regula_load_type("invalid_cloudtrail_s3_data_logging_no_trails_infra.cfn", "cfn")
