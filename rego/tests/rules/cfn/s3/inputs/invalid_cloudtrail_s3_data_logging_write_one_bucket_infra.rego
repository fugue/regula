...
#
#     tests/rules/cfn/s3/inputs/invalid_cloudtrail_s3_data_logging_write_one_bucket_infra.cfn
#
...
package tests.rules.cfn.s3.inputs.invalid_cloudtrail_s3_data_logging_write_one_bucket_infra

import data.fugue.regula.tests

mock_config := regula_load_type("invalid_cloudtrail_s3_data_logging_write_one_bucket_infra.cfn", "cfn")
