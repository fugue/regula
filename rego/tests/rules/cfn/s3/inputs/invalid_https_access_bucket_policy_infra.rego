...
#
#     tests/rules/cfn/s3/inputs/invalid_https_access_bucket_policy_infra.cfn
#
...
package tests.rules.cfn.s3.inputs.invalid_https_access_bucket_policy_infra

import data.regula

mock_config := regula_load_type("invalid_https_access_bucket_policy_infra.cfn", "cfn")
