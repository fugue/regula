...
#
#     tests/rules/cfn/s3/inputs/invalid_missing_infra.cfn
#
...
package tests.rules.cfn.s3.inputs.invalid_missing_infra

import data.fugue.regula.tests

mock_config := regula_load_type("invalid_missing_infra.cfn", "cfn")
