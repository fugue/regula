...
#
#     tests/rules/cfn/s3/inputs/valid_block_public_access_infra.cfn
#
...
package tests.rules.cfn.s3.inputs.valid_block_public_access_infra

import data.fugue.regula.tests

mock_config := regula_load_type("valid_block_public_access_infra.cfn", "cfn")
