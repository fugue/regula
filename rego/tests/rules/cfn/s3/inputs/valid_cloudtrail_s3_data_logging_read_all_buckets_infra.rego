...
#
#     tests/rules/cfn/s3/inputs/valid_cloudtrail_s3_data_logging_read_all_buckets_infra.cfn
#
...
package tests.rules.cfn.s3.inputs.valid_cloudtrail_s3_data_logging_read_all_buckets_infra

import data.fugue.regula.tests

mock_config := regula_load_type("valid_cloudtrail_s3_data_logging_read_all_buckets_infra.cfn", "cfn")
