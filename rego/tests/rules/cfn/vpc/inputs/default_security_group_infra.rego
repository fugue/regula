...
#
#     tests/rules/cfn/vpc/inputs/default_security_group_infra.cfn
#
...
package tests.rules.cfn.vpc.inputs.default_security_group_infra

import data.fugue.regula.tests

mock_config := regula_load_type("default_security_group_infra.cfn", "cfn")
