...
#
#     tests/rules/cfn/vpc/inputs/flow_logging_enabled_infra.cfn
#
...
package tests.rules.cfn.vpc.inputs.flow_logging_enabled_infra

import data.fugue.regula.tests

mock_config := regula_load_type("flow_logging_enabled_infra.cfn", "cfn")
