...
#
#     tests/rules/cfn/vpc/inputs/nacl_ingress_22_infra.cfn
#
...
package tests.rules.cfn.vpc.inputs.nacl_ingress_22_infra

import data.regula

mock_config := regula_load_type("nacl_ingress_22_infra.cfn", "cfn")
