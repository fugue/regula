...
#
#     tests/rules/tf/aws/cloudfront/inputs/distribution_https_infra.tf
#
...
package tests.rules.tf.aws.cloudfront.inputs.distribution_https_infra

import data.fugue.regula.tests

mock_config := regula_load_type("distribution_https_infra.tfplan", "tf-plan")
