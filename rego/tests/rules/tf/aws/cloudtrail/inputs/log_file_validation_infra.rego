...
#
#     tests/rules/tf/aws/cloudtrail/inputs/log_file_validation_infra.tf
#
...
package tests.rules.tf.aws.cloudtrail.inputs.log_file_validation_infra

import data.fugue.regula.tests

mock_config := regula_load_type("log_file_validation_infra.tfplan", "tf-plan")
