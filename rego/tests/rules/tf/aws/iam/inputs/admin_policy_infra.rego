...
#
#     tests/rules/tf/aws/iam/inputs/admin_policy_infra.tf
#
...
package tests.rules.tf.aws.iam.inputs.admin_policy_infra

import data.fugue.regula.tests

mock_config := regula_load_type("admin_policy_infra.tfplan", "tf-plan")
