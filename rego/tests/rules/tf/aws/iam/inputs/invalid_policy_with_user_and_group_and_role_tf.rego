...
package tests.rules.tf.aws.iam.inputs.invalid_policy_with_user_and_group_and_role_tf
...
mock_config := {
  ...
  "resources": {
    "aws_iam_group.group": {
      "_filepath": "tests/rules/tf/aws/iam/inputs/invalid_policy_with_user_and_group_and_role.tf",
      "_provider": "aws",
      "_type": "aws_iam_group",
