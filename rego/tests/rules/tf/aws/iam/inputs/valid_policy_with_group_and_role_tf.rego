...
package tests.rules.tf.aws.iam.inputs.valid_policy_with_group_and_role_tf
...
mock_config := {
  ...
  "resources": {
    "aws_iam_group.group": {
      "_filepath": "tests/rules/tf/aws/iam/inputs/valid_policy_with_group_and_role.tf",
      "_provider": "aws",
      "_type": "aws_iam_group",
    ...
    "aws_iam_group_policy_attachment.test-attach": {
      ...
      "group": "test-group",
      "id": "aws_iam_group_policy_attachment.test-attach",
    ...
    "aws_iam_role_policy_attachment.test-attach": {
      ...
      "id": "aws_iam_role_policy_attachment.test-attach",
      "policy_arn": "aws_iam_policy.policy",
      "role": "test-role"
    }
  }
