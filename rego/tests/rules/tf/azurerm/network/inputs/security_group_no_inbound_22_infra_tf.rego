...
package tests.rules.tf.azurerm.network.inputs.security_group_no_inbound_22_infra_tf
...
mock_config := {
  ...
  "resources": {
    "azurerm_network_security_group.invalidnsg1": {
      "_filepath": "tests/rules/tf/azurerm/network/inputs/security_group_no_inbound_22_infra.tf",
      "_provider": "azurerm",
