...
#
#     tests/rules/tf/azurerm/network/inputs/security_group_no_inbound_3389_infra.tf
#
...
package tests.rules.tf.azurerm.network.inputs.security_group_no_inbound_3389_infra
