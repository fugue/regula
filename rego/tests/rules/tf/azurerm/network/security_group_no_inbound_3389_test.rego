...
import data.tests.rules.tf.azurerm.network.inputs.security_group_no_inbound_3389_infra

test_network_security_group_no_inbound_3389 {
  pol = policy with input as security_group_no_inbound_3389_infra.mock_input
