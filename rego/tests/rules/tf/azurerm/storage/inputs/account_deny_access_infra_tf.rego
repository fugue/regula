...
package tests.rules.tf.azurerm.storage.inputs.account_deny_access_infra_tf
...
mock_config := {
  ...
  "resources": {
    "azurerm_resource_group.example": {
      "_filepath": "tests/rules/tf/azurerm/storage/inputs/account_deny_access_infra.tf",
      "_provider": "azurerm",
