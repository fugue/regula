...
#
#     tests/rules/tf/azurerm/storage/inputs/account_microsoft_services_infra.tf
#
...
package tests.rules.tf.azurerm.storage.inputs.account_microsoft_services_infra

import data.fugue.regula.tests

mock_config := regula_load_type("account_microsoft_services_infra.tfplan", "tf-plan")
