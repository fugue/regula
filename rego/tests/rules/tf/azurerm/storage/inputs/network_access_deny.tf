...
# The default network rules for a storage account allow public access and is invalid
...
resource "azurerm_storage_account_network_rules" "validrule1" {
  resource_group_name  = "${azurerm_resource_group.rg1.name}"
  storage_account_name = "${azurerm_storage_account.valid1.name}"
