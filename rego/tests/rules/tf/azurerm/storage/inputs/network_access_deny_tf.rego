...
package tests.rules.tf.azurerm.storage.inputs.network_access_deny_tf
...
mock_config := {
  ...
  "resources": {
    "azurerm_resource_group.rg1": {
      "_filepath": "tests/rules/tf/azurerm/storage/inputs/network_access_deny.tf",
      "_provider": "azurerm",
    ...
    "azurerm_storage_account_network_rules.validrule1": {
      "_filepath": "tests/rules/tf/azurerm/storage/inputs/network_access_deny.tf",
      "_provider": "azurerm",
      "_type": "azurerm_storage_account_network_rules",
      "default_action": "Deny",
      "id": "azurerm_storage_account_network_rules.validrule1",
      "resource_group_name": "random_string.seed-rg1",
      "storage_account_name": "random_string.seedvalid1"
    },
