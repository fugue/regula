...
#
#     tests/rules/tf/google/compute/inputs/firewall_no_ingress_22_infra.tf
#
...
package tests.rules.tf.google.compute.inputs.firewall_no_ingress_22_infra

import data.fugue.regula.tests

mock_config := regula_load_type("firewall_no_ingress_22_infra.tfplan", "tf-plan")
