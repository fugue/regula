...
package tests.rules.tf.google.compute.inputs.invalid_firewall_allow_port_range_tf
...
mock_config := {
  ...
  "resources": {
    "google_compute_firewall.allow_all": {
      "_filepath": "tests/rules/tf/google/compute/inputs/invalid_firewall_allow_port_range.tf",
      "_provider": "google",
