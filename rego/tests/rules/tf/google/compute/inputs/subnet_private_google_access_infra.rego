...
#
#     tests/rules/tf/google/compute/inputs/subnet_private_google_access_infra.tf
#
...
package tests.rules.tf.google.compute.inputs.subnet_private_google_access_infra
