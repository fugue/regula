...
package tests.rules.tf.google.compute.inputs.valid_firewall_equal_priorities_tf
...
mock_config := {
  ...
  "resources": {
    "google_compute_firewall.allow_all_22": {
      "_filepath": "tests/rules/tf/google/compute/inputs/valid_firewall_equal_priorities.tf",
      "_provider": "google",
