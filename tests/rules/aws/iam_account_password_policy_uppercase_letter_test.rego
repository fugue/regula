...
package tests.rules.iam_account_password_policy_uppercase_letter

import data.fugue.regula
import data.tests.rules.aws.inputs.iam_account_password_policy_infra.mock_plan_input

test_iam_account_password_policy_uppercase_letter {
  report := regula.report with input as mock_plan_input
  resources := report.rules.iam_account_password_policy_uppercase_letter.resources
