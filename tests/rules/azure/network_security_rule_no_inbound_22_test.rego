...
import data.tests.rules.azure.inputs.network_security_rule_no_inbound_22_infra.mock_plan_input

test_network_security_rule_no_inbound_22 {
  report := regula.report with input as mock_plan_input
  resources := report.rules.network_security_rule_no_inbound_22.resources
