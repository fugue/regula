package tests.rules.network_security_rule_no_ingress_3389

import data.fugue.regula

test_network_security_rule_no_ingress_3389 {
  report := regula.report with input as mock_input
  resources := report.rules.network_security_rule_no_ingress_3389.resources
