...
#
#     tests/rules/cfn/aws/api_gateway/inputs/invalid_v2_custom_domain_name_sam_infra.cfn
#
...
package tests.rules.cfn.aws.api_gateway.inputs.invalid_v2_custom_domain_name_sam_infra
