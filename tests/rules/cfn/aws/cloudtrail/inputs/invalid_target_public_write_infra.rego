...
#
#     tests/rules/cfn/aws/cloudtrail/inputs/invalid_target_public_write_infra.cfn
#
...
package tests.rules.cfn.aws.cloudtrail.inputs.invalid_target_public_write_infra
