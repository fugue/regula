...
#
#     tests/rules/cfn/aws/cloudtrail/inputs/s3_access_invalid_no_logging_infra.cfn
#
...
package tests.rules.cfn.aws.cloudtrail.inputs.s3_access_invalid_no_logging_infra
