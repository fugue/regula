...
#
#     tests/rules/cfn/aws/cloudtrail/inputs/s3_access_valid_cloud_trail_infra.cfn
#
...
package tests.rules.cfn.aws.cloudtrail.inputs.s3_access_valid_cloud_trail_infra
