...
#
#     tests/rules/cfn/aws/lambda/inputs/invalid_public_function_with_valid_infra.cfn
#
...
package tests.rules.cfn.aws.lambda.inputs.invalid_public_function_with_valid_infra
