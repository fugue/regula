...
#
#     tests/rules/cfn/aws/lambda/inputs/valid_private_function_account_permission_sam_infra.cfn
#
...
package tests.rules.cfn.aws.lambda.inputs.valid_private_function_account_permission_sam_infra
