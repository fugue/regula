...
package tests.rules.cfn_aws_s3_cloudtrail_s3_data_logging_read
...
test_valid_empty_document {
  ...
  resources := report.rules.cfn_aws_s3_cloudtrail_s3_data_logging_read.resources

  count(resources) == 0
}

test_valid_cloudtrail_s3_data_logging_read_all_buckets {
  report := regula.report with input as inputs.valid_cloudtrail_s3_data_logging_read_all_buckets_infra.mock_plan_input
  resources := report.rules.cfn_aws_s3_cloudtrail_s3_data_logging_read.resources
...
test_invalid_cloudtrail_s3_data_logging_read_one_bucket {
  report := regula.report with input as inputs.invalid_cloudtrail_s3_data_logging_read_one_bucket_infra.mock_plan_input
  resources := report.rules.cfn_aws_s3_cloudtrail_s3_data_logging_read.resources
...
test_valid_cloudtrail_s3_data_logging_write_one_bucket_read_all {
  report := regula.report with input as inputs.valid_cloudtrail_s3_data_logging_write_one_bucket_read_all_infra.mock_plan_input
  resources := report.rules.cfn_aws_s3_cloudtrail_s3_data_logging_read.resources
