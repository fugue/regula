...
package rules.cfn_aws_vpc_nacl_ingress_3389

import data.tests.rules.cfn.aws.vpc.inputs.nacl_ingress_3389_infra

test_nacl_ingress_3389 {
  pol = policy with input as nacl_ingress_3389_infra.mock_input
