...
#
#     tests/rules/cfn/lambda/inputs/valid_private_function_service_permission_infra.cfn
#
...
package tests.rules.cfn.lambda.inputs.valid_private_function_service_permission_infra
