...
#
#     tests/rules/cfn/lambda/inputs/valid_private_function_service_permission_sam_infra.cfn
#
...
package tests.rules.cfn.lambda.inputs.valid_private_function_service_permission_sam_infra
