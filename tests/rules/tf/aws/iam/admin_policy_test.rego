...
package tests.rules.tf_aws_iam_admin_policy

import data.fugue.regula
import data.tests.rules.tf.aws.iam.inputs.admin_policy_infra.mock_plan_input

test_admin_policy {
  report := regula.report with input as mock_plan_input
  resources := report.rules.tf_aws_iam_admin_policy.resources
