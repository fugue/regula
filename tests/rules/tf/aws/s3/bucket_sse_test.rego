...
package tests.rules.tf_aws_s3_bucket_sse

import data.fugue.regula
import data.tests.rules.tf.aws.s3.inputs.bucket_sse_infra.mock_plan_input

test_s3_bucket_sse {
  report := regula.report with input as mock_plan_input
  resources := report.rules.tf_aws_s3_bucket_sse.resources
