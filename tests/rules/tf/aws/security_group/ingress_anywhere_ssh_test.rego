...
package tests.rules.tf_aws_security_group_ingress_anywhere_ssh

import data.fugue.regula
import data.tests.rules.tf.aws.security_group.inputs.ingress_anywhere_ssh_infra.mock_plan_input

test_security_group_ingress_anywhere_ssh {
  report := regula.report with input as mock_plan_input
  resources := report.rules.tf_aws_security_group_ingress_anywhere_ssh.resources
