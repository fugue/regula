...
package tests.rules.tf_azurerm_network_security_group_no_inbound_22

import data.fugue.regula
import data.tests.rules.tf.azurerm.network.inputs.security_group_no_inbound_22_infra.mock_plan_input

test_network_security_group_no_inbound_22 {
  report := regula.report with input as mock_plan_input
  resources := report.rules.tf_azurerm_network_security_group_no_inbound_22.resources
