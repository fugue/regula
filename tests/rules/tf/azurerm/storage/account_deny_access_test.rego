...
package tests.rules.tf_azurerm_storage_account_deny_access

import data.fugue.regula
import data.tests.rules.tf.azurerm.storage.inputs.account_deny_access_infra.mock_plan_input

test_storage_account_deny_access {
  report := regula.report with input as mock_plan_input
  resources := report.rules.tf_azurerm_storage_account_deny_access.resources
